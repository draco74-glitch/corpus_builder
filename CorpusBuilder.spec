...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "corpus_builder.startup_dialog",
        "corpus_builder.finetune_window",
        "corpus_builder.postproc.format_converter",
        "corpus_builder.postproc.instruction_generator",
        "corpus_builder.postproc.chunker",
        "corpus_builder.postproc.quality_finetune",
        "corpus_builder.postproc.dataset_balancer",
        "corpus_builder.postproc.pii_filter",
